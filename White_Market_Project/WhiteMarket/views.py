...
def showListing(request, item_name_slug):
    ...
    return render(request, 'whitemarketitem.html', context=context_dict)
...
def myAccount(request,user_name_slug):
    ...
    context_dict['user'] = UserProfile.objects.get(slug=user_name_slug)
...
def listItem(request):
    ...
    return render(request, 'whitemarketlistItem.html', {'form': form})
